...
public class Item implements Serializable
{
    ...
    private final static long serialVersionUID = -73748171367133821L;
     ...
     */
    public Item(String tcin, BundleComponents bundleComponents, String dpci, String upc, ProductDescription productDescription, String buyUrl, Enrichment enrichment, String returnMethod, Handling handling, RecallCompliance recallCompliance, TaxCategory taxCategory, DisplayOption displayOption, Fulfillment fulfillment, PackageDimensions packageDimensions, EnvironmentalSegmentation environmentalSegmentation, Manufacturer manufacturer, List<ProductVendor> productVendors, ProductClassification productClassification, ProductBrand productBrand, String itemState, List<Object> specifications, Attributes attributes, String countryOfOrigin, String relationshipTypeCode, Boolean subscriptionEligible, List<Object> ribbons, List<Object> tags, String shipToRestriction, String estoreItemStatusCode, EligibilityRules eligibilityRules, Boolean isProposition65, ReturnPolicies returnPolicies, Packaging packaging) {
        super();
        this.tcin = tcin;
